...
%-------------------------------------------------------------------------------
\newcommand{\setDefaults}{\blue%
                          \Large%
                          \renewcommand{\listcolor}{\cyan}%
                          \renewcommand{\listfonts}{\large}}
\newcommand{\newSlide}[1]{\rotatefoilhead{}$ $\\[-2.0em]\centerline{\Huge #1}}
\newcommand{\slide}[1]%
{\rotatefoilhead{}$ $\\\vfill\begin{center}\Huge #1\end{center}\vfill}
\newcommand{\listfonts}{\large}
\newcommand{\listcolor}{\cyan}
\newenvironment{cpl}{\listfonts%
                     \listcolor%
                     \begin{list}{\ding{43}}{%
%                     \begin{list}{$\blacktriangleright$}{%
                       ...
                       \setlength{\leftmargin}{1.8\labelwidth}%
                     }}%
                    {\end{list}}
\newenvironment{li}{\begin{list}{\small$\diamondsuit$}{%
                      \setlength{\parskip}{0pt}%
                      \setlength{\topsep}{3pt}%
                      \setlength{\itemsep}{0pt}%
                      \setlength{\parsep}{0pt}%
                      \setlength{\leftmargin}{2.4\labelwidth}}}%
                    {\end{list}}

\newcommand{\cpfig}[4]{%
\begin{figure}[ht]%
\begin{center}%
\epsfig{file=#1,width=#2\textwidth}%
\end{center}%
\caption{#4}%
\label{#3}%
\end{figure}%
...
\newcommand{\cpchap}[1]{\chapter{\boldmath #1 \unboldmath}}
\newcommand{\cpsec}[1]{\section{\boldmath #1 \unboldmath}}
\newcommand{\cpsubsec}[1]{\boldmath\subsection{#1}\unboldmath}
\newcommand{\cpsubsubsec}[1]{\boldmath\subsubsection{#1}\unboldmath}

\newcommand{\cpquote}[1]{\begin{center}\begin{minipage}{0.9\textwidth}{#1}%
...
\newcommand{\ZZ}{\ensuremath{\mathrm{Z^0}}}
